        ...
        <>
            ...
            <div className="space-y-5 pt-4">
                <div className="flex items-center justify-between">
                    ...
                    >
                        <Plus size={15} />
                        Soumettre <span className="hidden sm:inline">une épreuve</span>
                    </button>
                </div>
            ...
            <Modal isOpen={!!confirmViewExam} onClose={() => setConfirmViewExam(null)} className="max-w-sm p-6">
                {confirmViewExam && (
                    <>
                        ...
                        <h3 className="mb-1 text-base font-semibold text-gray-900 dark:text-white">Voir l'épreuve</h3>
            ...
            <Modal isOpen={!!confirmExam} onClose={() => setConfirmExam(null)} className="max-w-sm p-6">
                {confirmExam && (
                    <>
                        ...
                        <h3 className="mb-1 text-base font-semibold text-gray-900 dark:text-white">Débloquer le corrigé</h3>
                        ...
                        <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
                            ...
                            >
                                <Zap size={15} />Confirmer (2 jetons)
                            </button>
                        </div>
                    </>
                )}
