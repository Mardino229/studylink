...
export function ResetPassword() {
    ...
    const onSubmit = (data: { email: string }) => {
        // TODO: Send request to backend to launch reset password operation
    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button className="font-medium hover:text-blue-700 hover:bg-transparent border-none p-0 shadow-none text-primary" variant="outline">Forgot your password?</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px]">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <input
                                        ...
                                        placeholder="yourname@uottawa.com"
                                    />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        ...
                        <DialogFooter>
                            <Button variant={resetPasswordRequest.isPending?'outline':'default'} type="button" onClick={form.handleSubmit(onSubmit)} className="text-sm font-semibold" disabled={resetPasswordRequest.isPending}>
                                {resetPasswordRequest.isPending ? <RotatingLines
                                    visible={true}
                                    strokeWidth="5"
                                    width="20"
                                    strokeColor="#135bec"
