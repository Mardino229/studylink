...
const USE_CASES = [
    {
        ...
        quote: "J'importe mes documents de cours et j'obtiens un résumé texte au audio condensé en 30 secondes. Je révise l'essentiel sans relire 80 pages.",
        label: "Résumés",
    ...
    },
    {
        ...
        quote: "Je discute avec un assistant qui m'explique les notions en s'appuyant sur mes propres notes de cours.",
