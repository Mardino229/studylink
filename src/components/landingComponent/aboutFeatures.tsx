...
const FEATURE_META = [
    ...
    { icon: Bot,           color: "bg-cyan-500/10 text-cyan-500 dark:bg-cyan-500/15 dark:text-cyan-400",     glow: "bg-cyan-400",    span: "lg:col-span-2", wide: true,  n: "05", badge: false },
    { icon: BookMarked,    color: "bg-emerald-500/10 text-emerald-500 dark:bg-emerald-500/15 dark:text-emerald-400", glow: "bg-emerald-400", span: "lg:col-span-2", wide: false, n: "06", badge: false },
    { icon: Video,         color: "bg-red-500/10 text-red-500 dark:bg-red-500/15 dark:text-red-400",         glow: "bg-red-400",     span: "lg:col-span-2", wide: false, n: "07", badge: false },
    { icon: FolderKanban,  color: "bg-orange-500/10 text-orange-500 dark:bg-orange-500/15 dark:text-orange-400", glow: "bg-orange-400",  span: "lg:col-span-3", wide: false, n: "08", badge: false },
    { icon: Mic,           color: "bg-violet-500/10 text-violet-500 dark:bg-violet-500/15 dark:text-violet-400", glow: "bg-violet-400",  span: "lg:col-span-3", wide: true,  n: "09", badge: true },
];
