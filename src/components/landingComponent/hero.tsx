...
export default function Hero() {
    return (
        <section
            id="home"
            className="relative lg:min-h-[80vh]  overflow-hidden bg-background py-24 sm:py-32"
        ...
        >
            ...
            <div className="relative container mx-auto flex min-h-[66vh] items-center px-4 sm:px-6 lg:px-8">
                <HeroContent />
            </div>
        </section>
    );
