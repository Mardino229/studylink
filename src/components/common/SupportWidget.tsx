...
const TICKET_TYPES: { value: TicketType; label: string; icon: React.ReactNode }[] = [
    { value: "report_issue",    label: "Signaler un bug",          icon: <Bug size={14} /> },
    { value: "feature_request", label: "Suggérer une fonctionnalité", icon: <Lightbulb size={14} /> },
    { value: "get_help",        label: "Obtenir de l'aide",        icon: <HelpCircle size={14} /> },
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-5 py-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-semibold text-gray-900 dark:text-white">Assistance</span>
                                </div>
                                <button
                                    type="button"
                                    onClick={handleClose}
                            ...
                            <div className="p-5">
                                {done ? (
                                    <div className="flex flex-col items-center gap-3 py-4 text-center">
                                        ...
                                        <p className="text-xs text-gray-500 dark:text-gray-400">Notre équipe prendra en compte votre retour.</p>
                                        <button
